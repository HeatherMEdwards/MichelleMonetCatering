...
4. **Commit** - With `Fix #N:` and `Closes #N` keywords
5. **Verify Locally** - Test with local server, confirm with user
...
## Step 5: Verify Locally (IMPORTANT)

**Before pushing, always verify changes locally and confirm with user.**
...
**Do NOT proceed to Step 6 until user says "push" or confirms changes are approved.**
